...
Given Ingreso a la URL luego ingreso a la opcion sigup para crear mi acceso, ingreso 'juanitoperez18' y Contraseña '1234567'
When Ingreso al login, con mi usuario 'juanitoperez18' y Contraseña '1234567'
